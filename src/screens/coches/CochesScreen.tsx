...
const styles = StyleSheet.create({
  ...
  filtroList: { backgroundColor: colors.surface, height: 54, borderBottomWidth: 1, borderBottomColor: colors.border, marginTop: spacing.sm },
  filtroContent: { paddingHorizontal: spacing.md, paddingVertical: 8, gap: spacing.sm, alignItems: 'center' },
