    ...
    >
      <View style={styles.cardHeader}>
        <View style={styles.cardLeft}>
          ...
          <Text style={styles.cardClient}>{item.cliente_nombre}</Text>
        </View>
        ...
        <FlatList
          ...
          ListEmptyComponent={
            <View style={styles.empty}>
              ...
              <Text style={styles.emptyText}>Sin encargos</Text>
            </View>
          }
        />
      )}
...
const styles = StyleSheet.create({
  ...
  cardClient: { ...typography.bodySmall, marginTop: 2 },
